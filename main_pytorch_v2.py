...
from src.dataloader_v2 import ToTensor_trace, Custom_Dataset
...
if __name__ == "__main__":
   ...
   # ---------------- Leakage Model ----------------
    ...
    if leakage == 'ID':
        ...
        def leakage_fn(att_plt, k):
            att_plt = int(att_plt.item() if hasattr(att_plt, "item") else att_plt)
            return bin(AES_Sbox[k ^ att_plt]).count("1")
        classes = 9
